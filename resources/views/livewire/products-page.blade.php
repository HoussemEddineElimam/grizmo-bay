        ...
        <div class="flex flex-wrap mb-24 -mx-3">
          <div class="w-full pr-2 lg:w-1/4 lg:block">
              ...
              <ul>
                ...
                <li class="mb-4">
                  <label for="sale" class="flex items-center dark:text-gray-300">
                    <input type="checkbox" class="w-4 h-4 mr-2" id="sale" wire:model.live="sale" value="1">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <div>
                <div class="text-lg font-semibold dark:text-white">{{Number::currency($price_range)}}</div>
                <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="2000" value="100" step="5">
                <div class="flex justify-between ">
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(50)}}</span>
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(2000)}}</span>
                </div>
              </div>
            </div>
          </div>
